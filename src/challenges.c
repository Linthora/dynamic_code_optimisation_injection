...
int main(int argc, char *argv[]) {
    ...
    if(argc < 2) {
        printf("Error: use ./build/challenges <prog_name> <opt: 1 for challenge 1, 2 for challenge 2, 3 for challenge 3 and 4>\n");
        printf("Error: Default is challenge 3 and 4\n");
        return -1;
    }
